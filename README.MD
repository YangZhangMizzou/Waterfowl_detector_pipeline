...
1. Extract all images from drone_collection.zip to example_images folder. Visit https://github.com
2. Extract all model weights from checkpoint.zip to checkpoint folder
